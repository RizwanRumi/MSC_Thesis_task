...
destination_video_dir = "./yolov5_output/"
...
if __name__ == "__main__":
    ...
    if net is not None:
        ...
        folder_path = "./input/"
        #folder_path = input("Enter the path of your file: ")
        assert os.path.isdir(folder_path), "The directory is not found. Please check the directory."
        
        filename = os.listdir(folder_path)
        
        # print(folder_path + "\\" + filename[0])

        capture = cv.VideoCapture(folder_path + filename[0])
        ...
        if capture.isOpened():
            ...
            result = cv.VideoWriter(destination_video_dir + 'propeller_inspection_video_v5.avi', cv.VideoWriter_fourcc(*'XVID'), 20.0, size)
            ...
            print("Please download the detected video file from yolov5_output folder in docker container.")
        else:
